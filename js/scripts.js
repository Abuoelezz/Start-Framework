!(function (U, fe) {
  ...
  function Ot(i, e, t, n, s) {
    const o = bi(e[t], n, s);
    o && (i.removeEventListener(t, o, Boolean(s)), delete e[t][o.uidEvent]);
  }
  function os(i, e, t, n) {
    const s = e[t] || {};
  ...
  const l = {
    ...
    off(i, e, t, n) {
      ...
      const [s, o, r] = vi(e, t, n),
        ...
        u = e.startsWith(".");
      if (void 0 === o) {
        if (u) for (const h of Object.keys(c)) os(i, c, h, e.slice(1));
        for (const [h, b] of Object.entries(d)) {
          const p = h.replace(ns, "");
          (a && !e.includes(p)) ||
  ...
  class qe extends Y {
    ...
    close() {
      if (l.trigger(this._element, rs).defaultPrevented) return;
      this._element.classList.remove("show");
      const e = this._element.classList.contains("fade");
      this._queueCallback(() => this._destroyElement(), this._element, e);
    }
    _destroyElement() {
      this._element.remove(), l.trigger(this._element, as), this.dispose();
    }
  ...
  const Oe = ".bs.swipe",
    ...
    ds = `pointerdown${Oe}`,
    us = `pointerup${Oe}`,
    fs = { endCallback: null, leftCallback: null, rightCallback: null },
    ps = {
  ...
  class it extends Re {
    ...
    _handleSwipe() {
      ...
      (this._deltaX = 0),
        t && j(t > 0 ? this._config.rightCallback : this._config.leftCallback);
    }
    _initEvents() {
      this._supportPointerEvents
        ? (l.on(this._element, ds, (e) => this._start(e)),
          l.on(this._element, us, (e) => this._end(e)),
          this._element.classList.add("pointer-event"))
        : (l.on(this._element, ls, (e) => this._start(e)),
          l.on(this._element, cs, (e) => this._move(e)),
          l.on(this._element, hs, (e) => this._end(e)));
    }
  ...
  class Le extends Y {
    ...
    _addEventListeners() {
      this._config.keyboard && l.on(this._element, gs, (e) => this._keydown(e)),
        "hover" === this._config.pause &&
          (l.on(this._element, _s, () => this.pause()),
          l.on(this._element, bs, () => this._maybeEnableCycle())),
        this._config.touch &&
          it.isSupported() &&
    ...
    _slide(e, t = null) {
      ...
      if (a(ms).defaultPrevented || !n || !o) return;
  ...
  l.on(document, ws, "[data-bs-slide], [data-bs-slide-to]", function (i) {
  ...
  const Xe = ".bs.collapse",
    ...
    Is = { parent: "(null|element)", toggle: "boolean" };
  class De extends Y {
    constructor(e, t) {
    ...
    show() {
      ...
      if (
        ...
        (e.length && e[0]._isTransitioning) ||
          l.trigger(this._element, Os).defaultPrevented)
      )
        return;
    ...
    _configAfterMerge(e) {
      return (e.toggle = Boolean(e.toggle)), (e.parent = ae(e.parent)), e;
    }
    _getDimension() {
    ...
    _getFirstLevelChildren(e) {
      const t = f.find(Ds, this._config.parent);
  ...
  function Ue(i) {
    for (var e = H(i), t = Ri(i); t && Ns(t) && "static" === se(t).position; )
      t = Ri(t);
    return t &&
  ...
  function Xi(i) {
    ...
    var T,
      ...
      K,
      L,
      S = Object.assign({ position: a }, d && Ps),
      W =
        !0 === u
          ? ((G = { x: p, y: m }),
            (N = H(t)),
        ...
        if (w) {
          ...
          if (a) {
            var Xn,
              ...
              ai = -1 !== [$, I].indexOf(C),
              Qn = null != (Xn = W?.[v]) ? Xn : 0,
              Gn = ai ? Un : Te - A[wt] - O[wt] - Qn + S.altAxis,
              Zn = ai ? Te + A[wt] + O[wt] - Qn - S.altAxis : Yn,
              Jn =
                p && ai
                  ? (es = Ye(Gn, Te, (li = Zn))) > li
                    ? li
                    : es
                  : Ye(p ? Gn : Un, Te, p ? Zn : Yn);
            (w[v] = Jn), (G[v] = Jn - Te);
          }
          e.modifiersData[n] = G;
        }
        ...
        (("body" !== Z(e) || Vt(a)) &&
          (d =
            (n = e) !== H(n) && R(n)
              ...
              : Rt(n)),
        R(e)
          ? (((u = je(e, !0)).x += e.clientLeft), (u.y += e.clientTop))
          : a && (u.x = qt(a))),
      {
        ...
        g = {
          ...
          forceUpdate: function () {
            if (!p) {
              ...
              if (rn(C, k)) {
                (h.rects = {
                  reference: Hs(C, Ue(k), "fixed" === h.options.strategy),
                  popper: Ht(k),
                }),
                  (h.reset = !1),
  ...
  var Bs = dt(),
    zs = dt({ defaultModifiers: [zt, Xt, Bt, Mt] }),
  ...
  const an = Object.freeze(
    ...
    Ys = `${be}.show`,
    ut = ".dropdown-menu",
    Qs = B() ? "top-end" : "top-start",
    Gs = B() ? "top-start" : "top-end",
    Zs = B() ? "bottom-end" : "bottom-start",
    Js = B() ? "bottom-start" : "bottom-end",
    eo = B() ? "left-start" : "right-start",
    to = B() ? "right-start" : "left-start",
    io = {
      autoClose: !0,
  ...
  class Q extends Y {
    ...
    _completeHide(e) {
      if (!l.trigger(this._element, qs, e).defaultPrevented) {
    ...
    _getPlacement() {
      ...
      if (e.classList.contains("dropend")) return eo;
      ...
      return e.classList.contains("dropup") ? (t ? Gs : Qs) : t ? Js : Zs;
    }
    _detectNavbar() {
  ...
  const ft = ".bs.focustrap",
    ...
    co = { autofocus: "boolean", trapElement: "element" };
  class _n extends Re {
    constructor(e) {
      super(),
        (this._config = this._getConfig(e)),
    ...
    activate() {
      this._isActive ||
        ...
        l.off(document, ft),
        l.on(document, ro, (e) => this._handleFocusin(e)),
        l.on(document, ao, (e) => this._handleKeydown(e)),
        (this._isActive = !0));
    }
    deactivate() {
  ...
  const q = ".bs.modal",
    ...
    po = `resize${q}`,
    mo = `click.dismiss${q}`,
    go = `mousedown.dismiss${q}`,
    _o = `keydown.dismiss${q}`,
    bo = `click${q}.data-api`,
    An = "modal-open",
    Gt = "modal-static",
    vo = { backdrop: !0, focus: !0, keyboard: !0 },
    yo = {
  ...
  class ve extends Y {
    ...
    hide() {
      this._isShown &&
        !this._isTransitioning &&
        (l.trigger(this._element, ho).defaultPrevented ||
          ((this._isShown = !1),
          (this._isTransitioning = !0),
        ...
        this._queueCallback(
          () => {
            this._config.focus && this._focustrap.activate(),
              (this._isTransitioning = !1),
              l.trigger(this._element, fo, { relatedTarget: e });
          },
          this._dialog,
          this._isAnimated()
        );
    ...
    _addEventListeners() {
      l.on(this._element, _o, (e) => {
        ...
        l.on(this._element, go, (e) => {
          l.one(this._element, mo, (t) => {
    ...
    _triggerBackdropTransition() {
      if (l.trigger(this._element, uo).defaultPrevented) return;
      const e =
  ...
  l.on(document, bo, '[data-bs-toggle="modal"]', function (i) {
    const e = f.getElementFromSelector(this);
  ...
  class re extends Y {
    ...
    show(e) {
      this._isShown ||
        l.trigger(this._element, Eo, { relatedTarget: e }).defaultPrevented ||
        ((this._isShown = !0),
        this._backdrop.show(),
        ...
        this._queueCallback(
          () => {
            (this._config.scroll && !this._config.backdrop) ||
              ...
              l.trigger(this._element, Ao, { relatedTarget: e });
          },
          this._element,
          !0
        ));
    ...
    hide() {
      this._isShown &&
        (l.trigger(this._element, To).defaultPrevented ||
          (this._focustrap.deactivate(),
          this._element.blur(),
          (this._isShown = !1),
  ...
  l.on(document, Oo, '[data-bs-toggle="offcanvas"]', function (i) {
    const e = f.getElementFromSelector(this);
  ...
  const $n = {
    ...
    Do = /^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:/?#]*(?:[/?#]|$))/i,
    $o = (i, e) => {
      const t = i.nodeName.toLowerCase();
      return e.includes(t)
        ? !So.has(t) || Boolean(Do.test(i.nodeValue))
  ...
  class jo extends Re {
    ...
    _checkContent(e) {
      for (const [t, n] of Object.entries(e))
        super._typeCheckConfig({ selector: t, entry: n }, Po);
    }
    _setContent(e, t, n) {
        ...
        ? (function (t, n, s) {
            ...
            for (const a of r) {
              ...
              const d = [].concat(...a.attributes),
                u = [].concat(n["*"] || [], n[c] || []);
              for (const h of d) $o(h, u) || a.removeAttribute(h.nodeName);
            }
  ...
  class ye extends Y {
    ...
    _getConfig(e) {
      ...
      for (const n of Object.keys(t)) Mo.has(n) && delete t[n];
      return (
  ...
  const Bo = {
    ...
    zo = { ...ye.DefaultType, content: "(null|string|element|function)" };
  class gt extends ye {
    static get Default() {
      return Bo;
    }
  ...
  const ei = ".bs.scrollspy",
    ...
    ti = "[href]",
    jn = ".nav-link",
    Vo = `${jn}, .nav-item > ${jn}, .list-group-item`,
    Ko = {
      offset: null,
  ...
  class Ze extends Y {
    ...
    _process(e) {
      this._activeTarget !== e &&
        ...
        l.trigger(this._element, Ro, { relatedTarget: e }));
    }
    _activateParents(e) {
      if (e.classList.contains("dropdown-item"))
        ...
        for (const t of f.parents(e, ".nav, .list-group"))
          for (const n of f.prev(t, Vo)) n.classList.add(We);
    }
    _clearActiveClass(e) {
  ...
  const we = ".bs.tab",
    ...
    Ee = "active",
    ni = "show",
    si = ":not(.dropdown-toggle)",
    Bn =
      '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',
    oi = `.nav-link${si}, .list-group-item${si}, [role="tab"]${si}, ${Bn}`,
    nr = `.${Ee}[data-bs-toggle="tab"], .${Ee}[data-bs-toggle="pill"], .${Ee}[data-bs-toggle="list"]`;
  class Ae extends Y {
    constructor(e) {
      super(e),
        ...
        this._parent &&
          ...
          l.on(this._element, Jo, (t) => this._keydown(t)));
    }
    static get NAME() {
      return "tab";
    }
    show() {
      ...
      const t = this._getActiveElem(),
        n = t ? l.trigger(t, Uo, { relatedTarget: e }) : null;
      l.trigger(e, Qo, { relatedTarget: t }).defaultPrevented ||
          ...
          () => {
            "tab" === e.getAttribute("role")
              ? (e.setAttribute("aria-selected", !1),
                ...
                l.trigger(e, Yo, { relatedTarget: t }))
    ...
    _keydown(e) {
      if (![tr, Mn, ir, Fn, ii, Hn].includes(e.key)) return;
  ...
  l.on(document, Zo, Bn, function (i) {
    ["A", "AREA"].includes(this.tagName) && i.preventDefault(),
      le(this) || Ae.getOrCreateInstance(this).show();
  }),
    l.on(window, er, () => {
      for (const i of f.find(nr)) Ae.getOrCreateInstance(i);
    }),
    z(Ae);
  const de = ".bs.toast",
    sr = `mouseover${de}`,
  ...
  class Je extends Y {
    ...
    _setListeners() {
      l.on(this._element, sr, (e) => this._onInteraction(e, !0)),
        l.on(this._element, or, (e) => this._onInteraction(e, !1)),
